...
FixStyle(qeq/reax/fixq,FixQEqReaxFixq)

#else

#ifndef LMP_FIX_QEQ_REAX_FIXQ_H
#define LMP_FIX_QEQ_REAX_FIXQ_H

#include "fix.h"

namespace LAMMPS_NS {

class FixQEqReaxFixq : public Fix {
 public:
  FixQEqReaxFixq(class LAMMPS *, int, char **);
  ~FixQEqReaxFixq();
  int setmask();
